  ...
  try {
        ...
        if(response!==""){
          ...
          if(data.status==200){
            swal({
              title: `Success`,
              text:`Account successfuly created. Please login.`,
              icon: "success",
            });
            navigate('/');
          } else {
                      ...
                      <form className="mx-1 mx-md-4">
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div data-mdb-input-init className="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example1c" className="form-control" value={details.name} onChange={(e) => setDetails({...details,name:e.target.value})}/>
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <i className="fas fa-user fa-lg me-3 fa-fw" />
                          <div data-mdb-input-init className="form-outline flex-fill mb-0">
                            <input type="text" id="form4Example1c" className="form-control" value={details.phone} onChange={(e) => setDetails({...details,phone:e.target.value})}/>
                            <label className="form-label" htmlFor="form4Example1c">Your Mobile No</label>
                          </div>
                        </div>
                        <div className="d-flex flex-row align-items-center mb-4">
                        ...
                        <div className="form-check d-flex justify-content-center mb-5">
                          <label className="form-check-label" htmlFor="form2Example3">
                            I have already an account. <a style={{"cursor":"pointer","textDecoration": "underline","color": "#0202ff"}} onClick={() => { navigate('/') }}>Login</a>
                          </label>
                        </div>
